...
class RoleController extends Controller {
    ...
    public function index(Request $request) {
        ...
        $roles = Role::where('name', 'like', '%'. $searchTerm .'%')->paginate(20);
        $roles->appends(['searchTerm' => $searchTerm]);
        return view('roles.index', compact('roles', 'searchTerm'));
    }
    ...
    public function store(Request $request) {
        $this->validate($request, [
            'name'=>'required|unique:roles,name|max:15',
